...
namespace myxsl.configuration {
   ...
   sealed class ProcessorElementCollection : ConfigurationElementCollection {
      ...
      public ProcessorElement Get(string name) {
         return (ProcessorElement)base.BaseGet(name);
      }
